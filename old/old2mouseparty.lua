local share = require 'https://raw.githubusercontent.com/expo/share.lua/4645d588f0e4c4b9b82053315939c43508e4b607/share.lua'
...
do
    ...
    function client.draw()
        ...
        if state then -- Initially state is `nil` so guard for that
            ...
            for mId, mouse in pairs(state.mice) do
                love.graphics.push('all')
                love.graphics.setColor(mouse.r, mouse.g, mouse.b)
                love.graphics.circle("fill", mouse.x, mouse.y, RADIUS)
                love.graphics.pop()
            end
